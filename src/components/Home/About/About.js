...
const About = () => {
  return (
    <div className="bg-[#000000] pb-6 px-12">
      {/* <div className="h-24 w-[1px] flex justify-center items-center mx-auto mt-[-50px] bg-white"></div> */}
      <div className="">
        <h2 className="textFormate text-xs text-[#757579] text-center pt-12">ABOUT ME</h2>
        ...
        <button className="uppercase flex justify-center mx-auto text-white text-sm border rounded-full py-2 px-6 border-[#bb47fd] mt-8">
          Learn More
        </button>
      </div>
    </div>
